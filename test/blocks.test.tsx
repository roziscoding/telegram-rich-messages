...
test("builds every InputRichBlock variant", () => {
    const output = richMessage(
        ...
        <>
            ...
            <List>
                ...
                <ListItem value={4} labelType="I">
                    <Paragraph>four</Paragraph>
                </ListItem>
            </List>
            <BlockQuote credit={<Bold>Ada</Bold>}>
            ...
            <Slideshow caption="Slides">
                <Video media={video} />
            </Slideshow>
            <Table bordered striped caption="Numbers">
                <TableRow>
                    <TableCell header align="center" valign="middle">
                        Name
                    </TableCell>
                    <TableCell>Value</TableCell>
                </TableRow>
                <TableRow>
                    <TableCell colspan={2}>Answer: 42</TableCell>
                    <TableCell />
                </TableRow>
            </Table>
            <Details summary={<Bold>More</Bold>} open>
                <Paragraph>Hidden-ish</Paragraph>
            </Details>
            <Map
    ...
    expect(output.blocks![6]).toEqual({
        ...
        items: [
            ...
            {
                blocks: [{ type: "paragraph", text: "four" }],
                value: 4,
                type: "I",
            },
        ],
