...
export interface InputRichBlockPullQuote {
    type: "pullquote";
    text: RichText;
    credit?: RichText;
}
...
type MessageEntitySimpleType = "mention" | "hashtag" | "cashtag" | "bot_command" | "url" | "email" | "phone_number" | "bold" | "italic" | "underline" | "strikethrough" | "spoiler" | "blockquote" | "expandable_blockquote" | "code";
...
export type InputRichBlock = InputRichBlockParagraph | InputRichBlockFooter | InputRichBlockThinking | InputRichBlockHeading | InputRichBlockPre | InputRichBlockDivider | InputRichBlockMathematicalExpression | InputRichBlockAnchor | InputRichBlockList | InputRichBlockBlockQuote | InputRichBlockPullQuote | InputRichBlockCollage | InputRichBlockSlideshow | InputRichBlockTable | InputRichBlockDetails | InputRichBlockMap | InputRichBlockAnimation | InputRichBlockAudio | InputRichBlockPhoto | InputRichBlockVideo | InputRichBlockVoiceNote;
export {};
